 ...
 * @author Arvid Heise
 */
public abstract class SopremoFunction1<Arg1 extends IJsonNode> extends SopremoFunction {
	/**
	 * 
	 */
	private static final long serialVersionUID = -8530159876315515042L;

	public SopremoFunction1(String name) {
		super(name, 1);
	}
	...
	protected abstract IJsonNode call(Arg1 arg1);
}
